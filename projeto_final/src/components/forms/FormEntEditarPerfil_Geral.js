...
class FormEntEditarPerfil_Geral extends React.Component {
                ...
                <div className="col-sm-12 col-md-9 mb-4 mt-2 editar_perfil_Geral">
                    <div className="row">
                        <div className="input-field col-12">
                            ...
                            />
                            <label htmlFor="NomeEmpresa" className={valores.NomeEmpresa != "" ? "col-12 active" : "col-12"}>Primeiro Nome</label>
                        </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        <div className="input-field col s12">
                            {valores.areaTrabalho !== "" ?
                                ...
                                >
                                    <option value="" disabled>Escolhe a Área de Trabalho</option>
                                ...
                                <select
                                    ...
                                    defaultValue={valores.areaTrabalho}
                                >
                                    <option value="" disabled selected>Escolhe a Área de Trabalho</option>
                                    <option value="3DAnimacao">3D e Animação</option>
                                    <option value="ArtesPerfomativas">Artes Performativas</option>
                                    <option value="ArtesPlasticas">Artes Plásticas</option>
                                    <option value="CinemaVideo">Cinema e Vídeo</option>
                    ...
                    <div className="row">
                        <div className="input-field col-12 col-md-6">
                            ...
                            />
                            <label htmlFor="Ocupacao" className={valores.ocupacao != "" ? "active col-12 col-md-6" : "col-12 col-md-6"}>Ocupação</label>
                    ...
                    <div className="row">
                        <div className="input-field col s12">
                            <textarea
                                ...
                                maxLength="400"
                            />
                            <label htmlFor="Sobre" className={valores.sobre != "" ? "active" : ""}>Sobre a Empresa</label>
                        </div>
                    </div>
                </div>
            </div>
...
export default connect(mapStateToProps)(FormEntEditarPerfil_Geral)